...
<body>
	...
	<div style="width:800px;height:auto;border:2px solid #ccc;">
		...
		<!-- 留言版面内容 -->
		<table class="easyui-datagrid" style="width:800px;height:auto;border:1px solid #ccc;table-layout:fixed">
		<thead>
			<tr>
				...
				<th data-options="field:'msgContent',align:'left'" style="min-width: 63%">留言内容</th>
			</tr>
		</thead>
		<tbody>
			...
			<tr>
				...
				<%--留言内容--%>
				<td style="min-width: 408px">${msg.msgContent }</td>
			</tr>
			</c:forEach>
		</tbody>
		</table>
